...
const Contact = () => {
  return (
    <div className="relative mb-[200px] min-h-[562px] w-[90%] mx-auto flex flex-col items-center justify-center rounded-[10px] overflow-hidden">
      ...
      <div className="relative z-[2] mx-auto border border-[#D4D4D8] w-[386px] h-[55px] flex rounded-[10px] overflow-hidden">
        <input
          className="h-full flex-1 pl-[15px] pr-[10px] placeholder:text-[#71717A] outline-none"
          type="mail"
          placeholder="Enter email address"
        />
        <button className="w-[139px] h-full bg-[#1FA1FF] text-white font-Poppins">
          Join
        </button>
      </div>
